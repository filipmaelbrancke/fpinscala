...
import fpinscala.datastructures.List.setHead
import fpinscala.datastructures.List.drop
...
class ListSpec extends FlatSpec with PropertyChecks{
  ...
  it should "throw a RuntimeException when getting passed an empty list" in {
